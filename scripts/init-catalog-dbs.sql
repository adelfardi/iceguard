...
--   nessiecat — second REST/"nessie" catalog (JdbcCatalog backend) persistence
...
SELECT 'CREATE DATABASE nessiecat'
WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'nessiecat')\gexec
