...
CREATE SEQUENCE alert_event_seq
    START WITH 1
    INCREMENT BY 50
    NO MINVALUE
    NO MAXVALUE
...
CREATE SEQUENCE alert_rule_seq
    START WITH 1
    INCREMENT BY 50
    NO MINVALUE
    NO MAXVALUE
...
CREATE SEQUENCE catalog_config_seq
    START WITH 1
    INCREMENT BY 50
    NO MINVALUE
    NO MAXVALUE
...
CREATE SEQUENCE execution_history_seq
    START WITH 1
    INCREMENT BY 50
    NO MINVALUE
    NO MAXVALUE
...
CREATE SEQUENCE maintenance_schedule_seq
    START WITH 1
    INCREMENT BY 50
    NO MINVALUE
    NO MAXVALUE
...
CREATE SEQUENCE pipeline_run_seq
    START WITH 1
    INCREMENT BY 50
    NO MINVALUE
    NO MAXVALUE
...
CREATE SEQUENCE pipeline_task_run_seq
    START WITH 1
    INCREMENT BY 50
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
CREATE SEQUENCE pipeline_task_seq
    START WITH 1
    INCREMENT BY 50
    NO MINVALUE
    NO MAXVALUE
...
CREATE SEQUENCE smtp_config_seq
    START WITH 1
    INCREMENT BY 50
    NO MINVALUE
    NO MAXVALUE
...
CREATE SEQUENCE spark_cluster_config_seq
    START WITH 1
    INCREMENT BY 50
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY spark_cluster_config
    ADD CONSTRAINT spark_cluster_config_name_key UNIQUE (name);
ALTER TABLE ONLY spark_cluster_config
    ADD CONSTRAINT spark_cluster_config_pkey PRIMARY KEY (id);
ALTER TABLE ONLY alert_event
    ADD CONSTRAINT fk1sehn6mpxtshf781kyly6ecre FOREIGN KEY (rule_id) REFERENCES alert_rule(id);
ALTER TABLE ONLY pipeline_run
    ADD CONSTRAINT fk2lsd1s3vpylu2opv2c5dfddco FOREIGN KEY (pipeline_id) REFERENCES pipeline(id);
ALTER TABLE ONLY pipeline
    ADD CONSTRAINT fk78nrlvux9vlhtuqhuwky528dl FOREIGN KEY (catalog_id) REFERENCES catalog_config(id);
ALTER TABLE ONLY execution_history
    ADD CONSTRAINT fka2j6cyw0lyshvyoqw39muw145 FOREIGN KEY (schedule_id) REFERENCES maintenance_schedule(id);
ALTER TABLE ONLY execution_history
    ADD CONSTRAINT fkax6u491okgyfsjgfrv2l2agjf FOREIGN KEY (catalog_id) REFERENCES catalog_config(id);
ALTER TABLE ONLY maintenance_schedule
    ADD CONSTRAINT fkbxen4cvwxapcvxdc1plei2b7g FOREIGN KEY (catalog_id) REFERENCES catalog_config(id);
ALTER TABLE ONLY alert_rule
    ADD CONSTRAINT fkd4ibyx2a1ojh2gmhdtsurfyyg FOREIGN KEY (catalog_id) REFERENCES catalog_config(id);
ALTER TABLE ONLY pipeline_task_run
    ADD CONSTRAINT fkegm0yubx7pm2vtx82he72fgpq FOREIGN KEY (task_id) REFERENCES pipeline_task(id);
ALTER TABLE ONLY pipeline_task
    ADD CONSTRAINT fksrbrj88yw2br3yop7pkk0cy87 FOREIGN KEY (pipeline_id) REFERENCES pipeline(id);
ALTER TABLE ONLY pipeline_task_run
    ADD CONSTRAINT fkt92c5vw3t1td8n33w0sa9vs2n FOREIGN KEY (run_id) REFERENCES pipeline_run(id);
